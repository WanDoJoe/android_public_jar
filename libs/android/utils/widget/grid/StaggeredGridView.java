 ...
 */
public class StaggeredGridView extends ExtendableListView implements OnScrollListener{
...
//        addFooterView(createFoodView( context));
    }
    public static View createFoodView(Context context){
